import { generateRandomNumber, validateGuess, formatAttempts, getEncouragementMessage, getFeedbackMessage } from '../../utils/gameUtils';
...
describe('gameUtils', () => {
  describe('generateRandomNumber', () => {
    ...
    it('should generate different numbers on multiple calls', () => {
      ...
      // With 10 calls, we should get at least 2 different numbers (statistically very likely)
